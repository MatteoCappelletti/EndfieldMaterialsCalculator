...
LEVEL_RANGES = [
    (20, LevelRange(820, 5, 2, 2, 0, 0)),     # 1-20
    (40, LevelRange(12540, 3, 8, 24, 0, 0)),  # 20-40
    (60, LevelRange(23900, 4, 5, 47, 0, 0)),  # 40-60
    (80, LevelRange(131890, 0, 0, 0, 7, 56)), # 60-80
    (90, LevelRange(252930, 0, 0, 0, 7, 61))  # 80-90
]
